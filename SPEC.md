# An uptime monitor allows users to enter URLs they want monitored, and recieve alerts when the resources "come back up" or "go down". These alerts will come as SMS.
